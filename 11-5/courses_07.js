...
function checkCodeShowCourse () {
  var i = courses.map(function (e) { return e.code; }).indexOf(elCD.value);
  if (i !== -1) {
...
var elCD = document.getElementById('Code');
elCD.addEventListener('input', checkCodeShowCourse, false);
